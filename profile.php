	...
	<div class="container">
				...
				<table>
					...
					<tbody>
						...
						foreach ($family_members as $family_member) {
							...
							<tr>
								<td>
									<?php echo $family_member["username"]; ?>
								</td>
								<td>
									<?php echo $name; ?>
								</td>
								<td>
									<?php echo $family_member["number"]; ?>
								</td>
								<td>
									<?php echo $family_member["dob"]; ?>
								</td>
								<td>
									<?php echo $privilege; ?>
								</td>
								<td>
									<form method="post">
										...
										<button type="submit" class="edit-button"
											name="edit_family_member_<?php echo $family_member['id']; ?>">Edit</button>
									</form>
								</td>
								<td>
									<form method="post">
		...
		<form method="post" id="settings-form">
			...
			<input type="text" name="number" id="number"
				value="<?php echo isset($user['number']) ? $user['number'] : ''; ?>">
